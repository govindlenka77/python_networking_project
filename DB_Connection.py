...
class DB_Access:
    ...
    def __init__(self):
        ...
        self.db = mysql.connector.connect(host='127.0.0.1', user="root", password="Govind@777", database="govindDB")
    ...
    def register_user(self):
        ...
        if username_info == "":
            ...
            sql = "insert into govind_table values(%s,%s,%s,%s)"
    ...
    def login_varify(self):
            ...
            sql = "select * from govind_table where username = %s and password = %s"
